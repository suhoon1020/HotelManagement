 ...
 * @author 심수훈
 */
public class BookInputADD2 extends javax.swing.JFrame {

    /**
     * Creates new form BookInput
     */
    public BookInputADD2() {
        initComponents();
    }
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookInputADD2.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookInputADD2().setVisible(true);
